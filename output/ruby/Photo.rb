...
def Facebook::Graph::Photo
  ...
  # The photo ID
  # Permissions: generic access_token or user_photos or friend_photos or
  ...
  # Permissions: generic access_token or user_photos or friend_photos or
  # user_photo_video_tags or friends_photo_video_tags
  # Returns: array of objects, the x and y coordinates are percentages from the
  # left and top edges of the photo, respectively
  attr_accessor :tags

  # The user provided caption given to this photo - do not include links or
  ...
  # Permissions: any valid access_token or user_photos or friend_photos or
  # user_photo_video_tags or friends_photo_video_tags
  ...
  # You can write to the PHOTO_ID/comments connection to post a comment to the
  # photo by issuing an HTTP POST request with the publish_stream permission and
  ...
  # You can unlike an photo by issuing an HTTP DELETE request to the
  # PHOTO_ID/likes connection with the publish_stream permission.
  # If the delete is successful, you get the following return.
  #  Description     Type    If the unlike succeeded     boolean   
  def delete_likes
  end

  # You can create a tag on the photo by issuing an HTTP POST request to the
  # tags connection, PHOTO_ID/tags.
  # Note: This feature is intended to help users tag their friends in real
  # photos. You should not use this feature to encourage users to tag their
  # friends if their friends are not actually in that photo, or to tag friends
  # in composite photos. If your app is found to be encouraging this behavior,
  # your usage of this feature may be disabled.
  # You can specify which user to tag using two methods: in the URL path as
  # PHOTO_ID/tags/USER_ID, or in a URL parameter as PHOTO_ID/tags?to=USER_ID. 
  # Currently, you cannot tag a Page in a photo using this API.
  # Tagging a photo requires the user_photos and publish_stream permissions, and
  # supports the following parameters.
  #  Parameter   Description   Type  Required    to      USER_ID of the User to
  # tag; can also be provided in URL path (see above).      string      yes    x
  #      x coordinate of tag, as a percentage offset from the left edge of the
  # picture      number      no    y      y coordinate of tag, as a percentage
  # offset from the top edge of the picture       number      no   
  # If the write is successful, you get the following return.
  #  Description     Type    If the update succeeded     boolean   
  def create_tags
  end

  # You can update the position of a tag for a particular user in the photo by
  # issuing a HTTP POST request to /PHOTO_ID/tags/USER_ID or
  # PHOTO_ID/tags?to=USER_ID with updated x and y coordinates.
  # Updating a tag on a photo requires the publish_stream permission and
  # supports the following parameters.
  #  Parameter   Description   Type  Required    to      USER_ID of the User to
  # tag; can also be provided in URL path (see above).      string      yes    x
  #      x coordinate of tag, as a percentage offset from the left edge of the
