...
def Facebook::Graph::Group
  ...
  # A flag which indicates if the group was created prior to launch of the
  # current groups product in October 2010
  # Permissions: generic access_token, user_groups, or friends_groups
  ...
  # Permissions: any valid access_token, user_groups, or friends_groups
  # Returns: array of objects containing id, and name, fields; some members will
  ...
  # Permissions: any valid access_token, user_groups, or friends_groups
  # Returns: array of objects containing id, from, subject, message, icon,
  ...
  # You can post a link on the Group's wall by issuing an HTTP POST request to
  # GROUP_ID/feed with the publish_stream permissions and the following
  # parameters.
  ...
  # You can create a post on a Group's wall by issuing an HTTP POST request to
  # GROUP_ID/feed with the publish_stream permissions and the following
  # parameters.
  ...
  # You can post a status message on a Group's wall by issuing an HTTP POST
  # request to GROUP_ID/feed with the publish_stream permissions and the
